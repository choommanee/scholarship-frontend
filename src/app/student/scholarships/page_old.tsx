...
const ScholarshipsPage: React.FC = () => {
    ...
    try {
      ...
      const transformedScholarships = (response.scholarships || []).map((s: any) => {
        ...
        return {
          ...
          requirements: [], // Will be populated from eligibility_criteria if needed
          applicants: s.total_quota - s.available_quota,
          maxApplicants: s.total_quota,
          isApplied: false, // TODO: Check from user's applications
  ...
  const getScholarshipStatus = (scholarship: Scholarship): "open" | "closing_soon" | "closed" => {
    const now = new Date();
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <Card>
                <CardBody className="p-6 text-center">
                  ...
                  <p className="text-2xl font-bold text-secondary-900 font-sarabun">
                    {scholarships.filter((s) => getScholarshipStatus(s) === "open").length}
                  </p>
                  <p className="text-sm text-secondary-600 font-sarabun">
                    เปิดรับสมัคร
                  </p>
              ...
              <Card>
                <CardBody className="p-6 text-center">
                  ...
                  <p className="text-2xl font-bold text-secondary-900 font-sarabun">
                    {
                      scholarships.filter((s) => getScholarshipStatus(s) === "closing_soon")
                        .length
                    }
                  </p>
                  <p className="text-sm text-secondary-600 font-sarabun">
